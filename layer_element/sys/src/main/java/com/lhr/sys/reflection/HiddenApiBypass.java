...
import com.lhr.sys.BuildConfig;
...
public final class HiddenApiBypass {
    ...
    static {
        try {
            ...
            assert unsafe != null;
            methodOffset = unsafe.objectFieldOffset(ReflectionHelper.Executable.class.getDeclaredField("artMethod"));
            classOffset = unsafe.objectFieldOffset(ReflectionHelper.Executable.class.getDeclaredField("declaringClass"));
            artOffset = unsafe.objectFieldOffset(ReflectionHelper.MethodHandle.class.getDeclaredField("artFieldOrMethod"));
            infoOffset = unsafe.objectFieldOffset(ReflectionHelper.MethodHandleImpl.class.getDeclaredField("info"));
            methodsOffset = unsafe.objectFieldOffset(ReflectionHelper.Class.class.getDeclaredField("methods"));
            iFieldOffset = unsafe.objectFieldOffset(ReflectionHelper.Class.class.getDeclaredField("iFields"));
            sFieldOffset = unsafe.objectFieldOffset(ReflectionHelper.Class.class.getDeclaredField("sFields"));
            memberOffset = unsafe.objectFieldOffset(ReflectionHelper.HandleInfo.class.getDeclaredField("member"));
            Method mA = ReflectionHelper.NeverCall.class.getDeclaredMethod("a");
            Method mB = ReflectionHelper.NeverCall.class.getDeclaredMethod("b");
            ...
            long aMethods = unsafe.getLong(ReflectionHelper.NeverCall.class, methodsOffset);
            ...
            Field fI = ReflectionHelper.NeverCall.class.getDeclaredField("i");
            Field fJ = ReflectionHelper.NeverCall.class.getDeclaredField("j");
            ...
            long iFields = unsafe.getLong(ReflectionHelper.NeverCall.class, iFieldOffset);
    ...
    public static Object newInstance(@NonNull Class<?> clazz, Object... initargs) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Method stub = ReflectionHelper.InvokeStub.class.getDeclaredMethod("invoke", Object[].class);
        Constructor<?> ctor = ReflectionHelper.InvokeStub.class.getDeclaredConstructor(Object[].class);
    ...
    public static List<Field> getStaticFields(@NonNull Class<?> clazz) {
        ...
        MethodHandle mh;
        try {
            Field fS = ReflectionHelper.NeverCall.class.getDeclaredField("s");
