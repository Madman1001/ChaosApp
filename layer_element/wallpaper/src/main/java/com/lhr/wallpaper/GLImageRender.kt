...
class GLImageRender(private val context: Context,
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        //创建着色器程序
        if (mProgramHandle == 0) {
            val vertexString = context.resources.openRawResource(R.raw.image_v).readText()
            val fragmentString= context.resources.openRawResource(R.raw.image_f).readText()
    ...
    override fun onDrawFrame(gl: GL10?) {
       ...
       GLES20.glUniform1i(uTextureUnitLocation, 0)
        ...
        GLHelper.checkGlError("uTextureUnitLocation")
