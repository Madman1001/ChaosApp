...
class GLBlurImageRender(private val context: Context,
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        //创建着色器程序
        if (mProgramHandle == 0) {
            val vertexString= ShaderUtils.readShader(context, R.raw.guass_v)
            val fragmentString= ShaderUtils.readShader(context, R.raw.guass_f)
    ...
    override fun onDrawFrame(gl: GL10?) {
       ...
       GLES20.glUniform1i(uSampler, 0)
        ...
        GLESUtils.checkGlError("uSampler")
